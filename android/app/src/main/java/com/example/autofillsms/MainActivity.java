...
public class MainActivity extends FlutterActivity implements FlutterPlugin, ActivityAware, MethodChannel.MethodCallHandler {
    ...
    private final PluginRegistry.ActivityResultListener activityResultListener = new PluginRegistry.ActivityResultListener() {
        ...
        public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
            if (requestCode == MainActivity.PHONE_HINT_REQUEST && pendingHintResult != null) {
                if (resultCode == Activity.RESULT_OK && data != null) {
                    Credential credential = data.getParcelableExtra(Credential.UserCredential.class.getSimpleName());
                    final Credential.UserCredential phoneNumber = credential.getUserCredential();
    ...
    private MainActivity(PluginRegistry.Registrar registrar) {
    ...
    public void onMethodCall(MethodCall call, @NonNull final MethodChannel.Result result) {
        switch (call.method) {
            ...
            case "listenForCode":
                ...
                task.addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        broadcastReceiver = new SmsBroadcastReceiver(new WeakReference<>(MainActivity.this),
                                smsCodeRegexPattern);
            ...
            case "getAppSignature":
                ...
                String appSignature = signatureHelper.getAppSignatures().get(0);
    ...
    private void requestHint() {
        ...
        try {
            activity.startIntentSenderForResult(intent.getIntentSender(),
                    MainActivity.PHONE_HINT_REQUEST, null, 0, 0, 0);
    ...
    private void setupChannel(BinaryMessenger messenger) {
        channel = new MethodChannel(messenger, MainActivity.channelName);
     ...
     * binding}. The {@code binding} may be cached and referenced until {@link #onDetachedFromEngine(FlutterPlugin.FlutterPluginBinding)}
     ...
     * #onAttachedToEngine(FlutterPlugin.FlutterPluginBinding)}. It is provided again in this method as a convenience. The {@code
    ...
    private static class SmsBroadcastReceiver extends BroadcastReceiver {
        ...
        final WeakReference<MainActivity> plugin;
        final String smsCodeRegexPattern;

        private SmsBroadcastReceiver(WeakReference<MainActivity> plugin, String smsCodeRegexPattern) {
            this.plugin = plugin;
